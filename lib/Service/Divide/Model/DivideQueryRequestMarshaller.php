...
class DivideQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var DivideQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new DivideQueryRequestMarshaller();
    }

    /**
     * @return DivideQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/divide/divide-query';
    ...
    /**
     * @param DivideQueryRequest $request
     * @return Request
     */
...
DivideQueryRequestMarshaller::__init();
