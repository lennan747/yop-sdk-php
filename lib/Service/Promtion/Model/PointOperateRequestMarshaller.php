...
class PointOperateRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getPointAccountNo() != null){
            $internalRequest->addParameter('pointAccountNo', ObjectSerializer::sanitizeForSerialization($request->getPointAccountNo(), 'string'));
        }
