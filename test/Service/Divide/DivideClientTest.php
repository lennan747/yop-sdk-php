...
class DivideClientTest extends TestCase
{
    ...
    {
        $request = new Model\DivideRequest();
        ...
        try{
            $response = self::$client->divide($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function divideQueryTest()
    {
        $request = new Model\DivideQueryRequest();
        ...
        $request->setUniqueOrderNo("uniqueOrderNo_example");
        try{
            $response = self::$client->divideQuery($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function dividebackTest()
    {
        $request = new Model\DividebackRequest();
        ...
        $request->setDivideBackDetail("{\"amount\":\"3.45\",\"divideBackReason\":\"退回原因01\",\"divideDetailNo\":\"1003232421231232\"},{\"amount\":\"2.35\",\"divideBackReason\":\"退回原因02\",\"divideDetailNo\":\"200323242123343\"}");
        try{
            $response = self::$client->divideback($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function dividebackQueryTest()
    {
        $request = new Model\DividebackQueryRequest();
        ...
        $request->setDivideBackRequestId("divideBackRequestId_example");
        try{
            $response = self::$client->dividebackQuery($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
